    ...
    return Container(
      ...
      child: Stack(
        children: <Widget>[
          ...
          Padding(
            //! Here you can change the position of the progressbar
...
class ContrastHelper {
  ...
  static double contrast(rgb1, rgb2) {
    return luminance(rgb2[0] as int, rgb2[1] as int, rgb2[2] as int) /
        luminance(rgb1[0] as int, rgb1[1] as int, rgb1[2] as int);
  }
}
